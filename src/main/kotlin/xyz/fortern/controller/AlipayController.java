...
import xyz.fortern.config.AliConfig;
...
public class AlipayController {
	...
	public AlipayController(AliConfig aliConfig) {
    ...
    public void toAlipay(HttpServletResponse response, HttpServletRequest request) throws Exception{
        ...
        AlipayClient alipayClient = new DefaultAlipayClient(
                aliConfig.getGatewayUrl(), aliConfig.getAppId(),
                aliConfig.getMerchantPrivateKey(), "json", aliConfig.getCharset(),
                aliConfig.getAlipayPublicKey(), aliConfig.getSignType());
        ...
        alipayRequest.setReturnUrl(aliConfig.getReturnUrl());//支付成功响应后跳转地址
        alipayRequest.setNotifyUrl(aliConfig.getNotifyUrl());//异步请求地址
    ...
    private boolean verifyAlipayReturn(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        try {// 调用SDK验证签名
            signVerified = AlipaySignature.rsaCheckV1(params,
                    aliConfig.getAlipayPublicKey(), aliConfig.getCharset(),
